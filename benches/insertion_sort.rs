...
#[ignore]
#[bench]
fn insertion_sort_10_000(b: &mut Bencher) {
    b.iter(|| {
...
#[ignore]
#[bench]
fn insertion_sort_10_000_few_keys(b: &mut Bencher) {
    b.iter(|| {
...
#[bench]
fn insertion_sort_1000_few_keys(b: &mut Bencher) {
    b.iter(|| {
...
#[ignore]
#[bench]
fn insertion_sort_presort_10_000(b: &mut Bencher) {
    b.iter(|| {
...
#[ignore]
#[bench]
fn insertion_sort_presort_10_000_few_keys(b: &mut Bencher) {
    b.iter(|| {
        sort(&mut SORTED_10_000_FEW.clone())
    });
}
#[bench]
fn insertion_sort_presort_1000(b: &mut Bencher) {
    b.iter(|| {
        sort(&mut SORTED_1000.clone())
    });
}
#[bench]
fn insertion_sort_presort_1000_few_keys(b: &mut Bencher) {
    b.iter(|| {
